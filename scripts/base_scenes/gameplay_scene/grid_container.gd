...
const ICON_HOURGLASS = preload("res://materials/base_scenes/gameplay_scene/show_hide_menu/agent_icons/hourglass.png")
const ICON_TIMER = preload("res://materials/base_scenes/gameplay_scene/show_hide_menu/agent_icons/timer.png")
const ICON_LEVEL_UP = preload("res://materials/base_scenes/gameplay_scene/show_hide_menu/agent_icons/levelup.png")
...
func refresh_slot(slot: TextureRect, agent: AgentStats) -> void:
	...
	if not agent:
		slot.texture = preload("res://materials/base_scenes/gameplay_scene/show_hide_menu/agent_icons/zaglushka.jpeg")
		slot.agent = null
		var refresh_overlay = slot.get_node_or_null("StatusOverlay")
		if refresh_overlay:
			refresh_overlay.visible = false
		var refresh_level_up_overlay = slot.get_node_or_null("LevelUpOverlay")
		if refresh_level_up_overlay:
			refresh_level_up_overlay.visible = false
		return
