...
const SquadScene = preload("res://all_scenes/ui_scenes/squad.tscn")
const QuestPanelScene = preload("res://all_scenes/ui_scenes/quest_descript.tscn")
const QuestSolveScene = preload("res://all_scenes/ui_scenes/quest_solve.tscn")
...
func _on_quest_spawned(quest: Quest, target_pos: Vector2, _mark_node: Node) -> void:
...
func _on_squad_arrived(_agents: Array, mark_node: Node) -> void:
...
func _on_help_button_pressed() -> void:
	...
	var help_scene = load("res://all_scenes/ui_scenes/guide.tscn")
	if help_scene:
