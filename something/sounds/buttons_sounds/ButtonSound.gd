...
func _ready():
	register_sound_profile("electro_hover", "res://something/sounds/buttons_sounds/el_button_hover.mp3", 0.9, 1.0)
	register_sound_profile("electro_press", "res://something/sounds/buttons_sounds/el_button_pressed.wav", 0.9, 1.0)
	register_sound_profile("pc_hover", "res://something/sounds/buttons_sounds/pc_button_hover.mp3", 0.9, 1.0)
	register_sound_profile("pc_press", "res://something/sounds/buttons_sounds/pc_button_pressed.wav", 0.9, 1.0)
